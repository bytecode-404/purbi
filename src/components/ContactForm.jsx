...
function ContactForm() {
  ...
  const mandatoryFields = ["name", "email", "profession", "country", "city", "state", "phoneNo", "contribution"];
  ...
  const GOOGLE_APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbyWsbzkRcBDvLvI7lp2vwtcyVa5FvgmoEfPY2VNGu-FWB-xJXtRMFYFKcFxqAVIpnEf/exec";
      ...
      <div className="relative mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-[28px] border border-[color:var(--color-border)] bg-white/70 backdrop-blur shadow-lg p-8 sm:p-12">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* How would you like to contribute Field */}
            <div>
              <label className="block text-sm font-semibold text-[color:var(--color-brand)] mb-2">
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Share your ideas on how you'd like to contribute to PURBI..."
                rows="4"
                className="w-full px-4 py-3 rounded-lg border border-[color:var(--color-border)] bg-white/50 focus:outline-none focus:ring-2 focus:ring-[color:var(--color-gold)] transition resize-none"
              />
            </div>
